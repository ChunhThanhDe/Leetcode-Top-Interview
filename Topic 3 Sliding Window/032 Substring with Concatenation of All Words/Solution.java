...
class Solution {
    ...
    public List<Integer> findSubstring(String s, String[] words) {
        ...
        // Populate the `wordCount` map with word frequencies
        for (String word : words) {
            wordCount.merge(word, 1, Integer::sum); // Increment count of each word
        }
        ...
        List<Integer> indices = new ArrayList<>(); // List to store valid starting indices
